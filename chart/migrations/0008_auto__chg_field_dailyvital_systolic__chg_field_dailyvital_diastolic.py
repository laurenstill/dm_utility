...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyVital.systolic'
        db.alter_column('chart_dailyvital', 'systolic', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyVital.diastolic'
        db.alter_column('chart_dailyvital', 'diastolic', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'DailyVital.systolic'
        db.alter_column('chart_dailyvital', 'systolic', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'DailyVital.diastolic'
        db.alter_column('chart_dailyvital', 'diastolic', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        'chart.dailyvital': {
            ...
            'diastolic': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'systolic': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
