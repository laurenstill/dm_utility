...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chart_medication', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('medication', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('started_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('stopped_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('side_effects', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('prescribing_dr', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('dosage', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('comments', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
        ))
        db.send_create_signal('chart', ['Medication'])

        # Deleting field 'DailyVital.medications'
        db.delete_column('chart_dailyvital', 'medications')

        # Adding field 'DailyVital.height'
        db.add_column('chart_dailyvital', 'height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'DailyVital.weight'
        db.alter_column('chart_dailyvital', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting model 'Medication'
        db.delete_table('chart_medication')

        # Adding field 'DailyVital.medications'
        db.add_column('chart_dailyvital', 'medications',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)

        # Deleting field 'DailyVital.height'
        db.delete_column('chart_dailyvital', 'height')


        # Changing field 'DailyVital.weight'
        db.alter_column('chart_dailyvital', 'weight', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        'chart.medication': {
            ...
            'stopped_at': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'chart.userprofile': {
