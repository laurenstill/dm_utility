...
current big issues:
changed models for a more robust medications model
schemamigration no bueno
user update page does not post to db
date/time autoload widget wonky




to do now: 
predictive medication input on update form
medication managment widgit on dashboard (details from user input and FDA file)




to do later:
download and/or print information logged (CCD CCR HTML TXT or other format.  Options?)
email input 
fitbit/monitor input
styling shit, design, all that crap
